                          ...
                          <div className="space-y-2 text-xs text-gray-400">
                            ...
                            <div className="flex justify-between items-center border-t border-gray-800 pt-2 mt-2">
                              <span className="font-bold text-gray-300">
                                {f.tipoContrato === 'PJ' ? 'Valor Líquido Desejado' : 'Salário Bruto'}
                              </span>
            ...
            <div className="space-y-5">
              ...
              {loading ? (
                ...
                <div className="space-y-6">
                  {funcionarios.map(f => {
                    const c = calcularCustos(f.salarioBruto || 0, f.tipoContrato);
                    const rows = c.isPJ 
                      ? [
                          { label: 'Valor Líquido Desejado', value: c.valorLiquido, color: 'text-white', bold: true },
                          { label: 'Simples Nacional (6%)', value: c.aliquotaSimples, color: 'text-rose-400' },
                          { label: 'ISS (5%)', value: c.iss, color: 'text-rose-400' },
                          { label: 'Total de Impostos (NFS-e)', value: c.impostoRetido, color: 'text-amber-400' },
                        ]
                      : [
                        ...
                        <div className="flex items-center gap-3 px-6 py-4 border-b border-gray-800 bg-gray-900/80">
                          ...
                          <div className="ml-auto text-right">
                            <p className="text-xs text-gray-400 font-medium">
                              Custo Real {c.isPJ ? '(Valor Bruto)' : 'Mensal'}
                            </p>
                            ...
                            <tbody className="divide-y divide-gray-800/60">
                              ...
                              <tr className="bg-indigo-950/40 border-t-2 border-indigo-500/30">
                                <td className="px-6 py-4 text-sm font-extrabold text-white">
                                  ✦ Custo {c.isPJ ? 'Total Bruto do Contrato (PJ)' : 'Real Mensal Total'}
                                </td>
