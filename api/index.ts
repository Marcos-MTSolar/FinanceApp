...
// O pdfjs-dist (dependência interna do pdf-parse) tenta acessar DOMMatrix, DOMPoint e
// Path2D que não existem no Node.js. Esses stubs silenciam o erro ReferenceError.
